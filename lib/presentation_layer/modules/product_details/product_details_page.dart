                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        child: CircleAvatar(
                          ...
                          child: Padding(
                            padding:
                                EdgeInsets.only(top: 2.height, right: 2.width),
                            child: Icon(
                              Icons.share,
                              color: design.white,
                              size: 22.fontSize,
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                'R\$${((widget.product ?? state.product!).value * _quantityProduct).formatWithCurrency().trim()}',
                                style: design
                                    .h5(
                                      color: design.secondary100,
                                    )
                                    ...
                                    onPressed: () {
                                      ...
                                      while (_quantityProduct != 0) {
                                        list.add(
                                            (widget.product ?? state.product!)
                                                .copyWith(
                                          id: (widget.product ?? state.product!)
                                              .id,
                                          note:
